...
//import com.ReportGeneration.string;
...
public class GenericFunctions extends TestNGListeners {
	...
	**************************************************/
	...
	public static boolean signin_succsfull(WebElement Header, String value){
		boolean status = true;
		try{
			String str_Header=Header.getText();
			System.out.println(str_Header);
			if(str_Header.equalsIgnoreCase(value)){
				status=true;
	...
	public static void select_Dropdown(WebElement ele,String value1){
		
		Select sc=new Select(ele);
	
		sc.selectByValue(value1);
	}
	
	public static void settext(WebElement text){
